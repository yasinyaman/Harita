...
class kullanici(Base):
    def get(self,i):
        ...
        if self.current_user:
            self.render("kullanici_profili.html",kullanici_adi=self.get_user_name(),kullanici = kullanici,avatar = gravatar.Gravatar(kullanici["email"],50),yakinlardakiler=yakinlardakiler)
        else:
